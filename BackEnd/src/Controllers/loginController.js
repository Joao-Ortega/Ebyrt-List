...
var LoginController = /** @class */ (function () {
    function LoginController(loginService) {
        var _this = this;
        this.checkLogin = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, email, password, userFromDb, _b, id, username, err_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._loginService.checkLogin(email, password)];
                    case 2:
                        userFromDb = _c.sent();
                        if (userFromDb === 404) {

...
var TasksService = /** @class */ (function () {
    function TasksService(tasksModel) {
        var _this = this;
        this.tasksFromUser = function (id) { return __awaiter(_this, void 0, void 0, function () {
            var usersTasks;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.tasksModel.allTasksFromUser(id)];
                    case 1:
                        usersTasks = _a.sent();
                        return [2 /*return*/, usersTasks];
                }
            });
        }); };
        this.createTasks = function (tasksInfos) { return __awaiter(_this, void 0, void 0, function () {
            var isInserted;
            return __generator(this, function (_a) {
                switch (_a.label) {

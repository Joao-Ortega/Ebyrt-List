        ...
        <div className="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
          <form style={{ width: "20rem" }}>
            ...
            <div className="pt-1 mb-4">
              <button
                className="btn btn-danger btn-lg btn-block" type="button"
                onClick={ handleLogin }
              >
                Entrar
              </button>
            </div>
            <p>Não tem uma conta? <a href="/register" className="link-info">Registre-se aqui</a></p>
          </form>
        </div>
      </div>
      <div className="col-sm-8 px-0 d-none d-sm-block">
        <img src="https://conteudo.imguol.com.br/c/entretenimento/65/2018/10/10/turbine-5-foto-abre-1539199563090_v2_1x1.png"
